const {
  ...
  regExpCheckPackage = /require(\s+|)\((\s+|)[`'"]([^`'"]+)[`'"](\s+|)\)/g,
  packageAlready = [],
  spinner = [
    '\u280B',
    '\u2819',
...
module.exports = async function (
  ...
  if (_0x459c96) {
    for (const _0x5d1c86 of _0x459c96) {
      const { aliases: _0xf54298, commandName: _0x2cabd8 } = _0x5d1c86
      for (const _0x455db4 of _0xf54298)
        if (GoatBot.aliases.has(_0x455db4)) {
          throw new Error(
            'Alias "' +
              _0x455db4 +
  ...
  let _0x2b5a43, _0x15552a, _0x15df96
  for (const _0x50f23c of _0x8d8a9b) {
    const _0x5cbdca =
      _0x50f23c == 'cmds'
        ? _0x3d33a0('RANA LOAD COMMANDS')
        : _0x3d33a0('RANA LOAD COMMANDS EVENT')
    ...
    const _0x1c21fe = path.normalize(process.cwd() + ('/scripts/' + _0x50f23c)),
      _0x384f2d = readdirSync(_0x1c21fe).filter(
        (_0x33580f) =>
          _0x33580f.endsWith('.js') &&
          !_0x33580f.endsWith('eg.js') &&
          (process.env.NODE_ENV == 'development'
            ? true
            : !_0x33580f.match(/(dev)\.js$/g)) &&
          !configCommands[
            _0x50f23c == 'cmds' ? 'commandUnload' : 'commandEventUnload'
          ]?.includes(_0x33580f)
      ),
      _0x43777d = []
    let _0x41c646 = 0
    for (const _0x2673d8 of _0x384f2d) {
      ...
      try {
        ...
        if (_0x5ba544) {
          _0x5ba544 = _0x5ba544
            .map((_0x1494b2) => _0x1494b2.match(/[`'"]([^`'"]+)[`'"]/)[1])
            .filter(
              (_0x3901b4) =>
                _0x3901b4.indexOf('/') !== 0 &&
                _0x3901b4.indexOf('./') !== 0 &&
