process.stdout.write("]2;Goat Bot V2 - Made by NTKhang Fixed by RANA\\");
...
centerText(gradient("#9F98E8", "#AFF6CF")("Created by NTKhang + RANA  with ♡"), "Created by NTKhang + ArYAN  with ♡".length);
